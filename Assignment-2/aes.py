...
def text2matrix(text):
    ...
    for i in range(16):
        ...
        if i % 4 == 0:
            ...
            matrix[i // 4].append(byte)  # Use // for integer division
    return matrix
...
key = 0x2b7e151628aed2a6abf7158809cf4f3c  # Example key
plaintext = 0x3243f6a8885a308d313198a2e0370734  # Example plaintext

# Create an AES instance with the key
aes = AES(key)
...
print(f"Decrypted Plaintext: {decrypted_plaintext:032x}")